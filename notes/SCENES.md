...
This document breaks the story into **atomic scenes**.
...
### Scene 1 — Morning Drift
- Characters: Rei
- Goal: establish baseline perception
- Beat: Rei moves through subtle connections with others
- Turn: she cannot distinguish where she ends and others begin
...
### Scene 1 — Attempted Control
- Characters: Rei
- Goal: reduce connection
- Beat: tries to limit depth
- Turn: feels unnatural

---

### Scene 2 — Failure with Yui
- Characters: Rei, Yui
- Goal: test control
- Beat: inconsistent connection
...
- move emotional state
- shift understanding
- or create consequence
